            ...
            <Section id='about' className='pb-12 font-normal lg:max-w-xl'>
              ...
              <div className='flex flex-col gap-2 text-sm sm:text-base'>
                <p>
                  ...
                  I&apos;m a classically trained composer who now channels that
                  same drive into software engineering.
                </p>
                <p>
                  My primary focus revolves around building full-stack software
                  and user interfaces using technologies like TypeScript,
                  Next.js, and Docker. During my free time, I like to explore
                  and integrate modern technologies such as AWS Lambda and
                  GoLang into my personal projects. Additionally, I delve into
                  the intricacies of data structures and algorithms to further
                  hone my skills.
                </p>
                <p>
